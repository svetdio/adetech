$(function () {
    $('#add_item').on('click', function (e) {
        ...
        let item_type = $('#add_item_form select#item_type').val();
        ...
        if (typeof item_type == 'undefined') {
            $('#add_item_form span#item_type').html('Item Type is required.');
        } else {
            $('#add_item_form span#item_type').html("");
        }
        if (discount == "") {
        ...
        if (!hasError) {
            ...
            frm.append('item_type', item_type);
    ...
    $.get('api/get_products.php', function (res) {
        ...
        $('.btn-edit-item').unbind('click').on('click', function () {
            ...
            $('#upd_item_form select#item_type').val(item_details.item_type);
            ...
            $('#upd_item').on('click', function (e) {
                ...
                let item_type = $('#upd_item_form select#item_type').val();
                let hasError = false;
                ...
                if (item_type == "") {
                    $('#upd_item_form span#item_type').html('Item Type is required.');
                } else {
                    $('#upd_item_form span#item_type').html("");
                }
                ...
                if (!hasError) {
                    ...
                    if (item_type !== item_details.item_type) {
                        frm.append('item_type', item_type);
                    }
